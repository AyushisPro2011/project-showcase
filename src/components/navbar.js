    ...
    return(
        ...
        <div id="navbar" style={{backgroundColor : "black" , opacity : 0.45 , display : "flex" , justifyContent : "space-between" , flexDirection : "row" , padding : "0.5%",border : "2px solid white" , borderRadius : "5px"}}>
           <h2 style={{color:"white" , }}><button style = {{border : "1px solid white" , width:"100%" , height : "100%" ,  borderRadius : "20px" ,backgroundColor: "pink"  }}> <Link to = "/">Other apps</Link></button></h2>
            ...
            <h2 style={{color:"white" ,}}><button style = {{border : "1px solid white",  height : "100%" , borderRadius : "20px" , width : "200%",backgroundColor: "pink"  }}><Link to={"/contact"}>Contact</Link></button></h2>
