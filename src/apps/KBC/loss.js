...
const Loss = () =>{
    ...
    <Navbar Text={"You Lost Lol"}/>
        ...
        <h6 style={{color : "green" , fontSize : "200%" , textAlign : "center" , textShadow : "3px 2px 10px lightgray"}} id="KBC-loss-head2">You chose the wrong Option</h6>
        <button  style={{color : "green" , fontSize : "200%" , textAlign : "center" , textShadow : "3px 2px 10px lightgray" , position :"absolute" , left : "38%" , background : "lightpink"}} id="KBC-loss-try-again"><Link to={"/KBC"} style={{textDecoration : "none" , color : "darkgreen"}}>Go back and Try Again</Link></button>
